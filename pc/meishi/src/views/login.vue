    ...
    <div class="loginbox" id='dl' v-show='show1'>
      ...
      <div class="loginbox_body">
        ...
        <div class="login_b1">
          ...
          <!-- 密码 -->
          <div class="litem">
            <input type="text" placeholder="请输入密码" class='text yzm' v-model='password'>
            <a href="" class="lbutton">立即登录</a>
          </div>
          <!-- 多选框 -->
    ...
    <div class="nl_more_zc" id='zc' v-show='show2'>
      <div class="nl_loginbox_www">
        ...
        <div class="nl_loginbox_w" style="float:left;">
          <div class="litem">
            <input type="text" v-model="reg_name" class="text forcheck pn_forcheck"  placeholder="请输入用户名">
          </div>

          <div class="litem">
            <input type="text" class="text forcheck pyzm_forcheck1 yzm" placeholder="请输入密码" v-model='reg_pwd'>
            <a href="javascript:;" class="phone_yzmbtn" id="phone_yzmbtn1">立即注册</a>
          </div>
